...
Reads the connection string from DATABASE_URL (falling back to db.base's local
default) so the same migrations apply to Neon, local Postgres, and test DBs.
Target metadata is the SQLAlchemy models in db.models, enabling autogenerate.
"""
...
from db.base import Base, get_database_url  # noqa: E402
