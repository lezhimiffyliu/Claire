        ...
        >
          ...
          >
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--claire-teal)]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-[var(--claire-teal)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
