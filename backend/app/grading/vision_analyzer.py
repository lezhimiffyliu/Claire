...
from app.content.problem_loader import Problem
from app.grading.grader import GradingResult
...
def analyze_with_verifier(
    ...
    """
    from app.grading.verifier import verify_answer, AnswerVerificationResult
    from app.grading.alignment_checker import check_problem_alignment
